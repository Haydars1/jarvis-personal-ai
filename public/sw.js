const CACHE='jarvis-v7.4-navfix-20260912';
const STATIC=['/','/app.css','/app.js','/credential-autotest.js','/integrations-ui.js','/higgsfield-ui.js','/provider-catalog.js','/navigation-state.js','/manifest.webmanifest','/icon.svg'];
